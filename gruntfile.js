  ...
  grunt.initConfig({
    ...
    handlebars: {
      compile: {
        ...
        files: {
          ...
          "handlebars/compiled/template_secondary.js":
            "handlebars/template_secondary.hbs",
    ...
    sass: {
      options: {
        ...
        // Resolve imports like "normalize-scss/..." from node_modules
        includePaths: ["node_modules"],
        // Hide deprecation warnings coming from third-party packages
        quietDeps: true,
        // Project still uses @import and grunt-sass 3 uses the legacy JS API
    ...
    terser: {
      ...
      my_target: {
        files: {
          ...
          "js/templates/template_secondary.js": [
            "handlebars/compiled/template_secondary.js",
          ],
    ...
    watch: {
      ...
      tasks: ["handlebars", "copy", "sass", "jshint", "terser", "postcss"],
      options: {
        interrupt: true,
      },
    },
